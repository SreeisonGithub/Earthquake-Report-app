...
Quakes quakesFromJson(String str) => Quakes.fromJson(json.decode(str));

String quakesToJson(Quakes data) => json.encode(data.toJson());
...
class Quakes {
    ...
    factory Quakes.fromJson(Map<String, dynamic> json) => Quakes(
        type: json["type"],
...
enum Net { AK, CI, UW, NN, NC, MB, HV, UU, US, TX, PR, OK, NM, AV }
...
enum PropertiesType { EARTHQUAKE, QUARRY_BLAST }
